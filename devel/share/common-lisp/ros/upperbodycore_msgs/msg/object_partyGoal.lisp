...
;//! \htmlinclude object_partyGoal.msg.html

(cl:defclass <object_partyGoal> (roslisp-msg-protocol:ros-message)
  ((input
    :reader input
    :initarg :input
    :type cl:string
...
(cl:defclass object_partyGoal (<object_partyGoal>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <object_partyGoal>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'object_partyGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name upperbodycore_msgs-msg:<object_partyGoal> is deprecated: use upperbodycore_msgs-msg:object_partyGoal instead.")))

(cl:ensure-generic-function 'input-val :lambda-list '(m))
(cl:defmethod input-val ((m <object_partyGoal>))
...
(cl:defmethod object1-val ((m <object_partyGoal>))
...
(cl:defmethod object2-val ((m <object_partyGoal>))
...
(cl:defmethod object3-val ((m <object_partyGoal>))
  ...
  (object3 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <object_partyGoal>) ostream)
  "Serializes a message object of type '<object_partyGoal>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <object_partyGoal>) istream)
  "Deserializes a message object of type '<object_partyGoal>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<object_partyGoal>)))
  "Returns string type for a message object of type '<object_partyGoal>"
  "upperbodycore_msgs/object_partyGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'object_partyGoal)))
  "Returns string type for a message object of type 'object_partyGoal"
  "upperbodycore_msgs/object_partyGoal")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<object_partyGoal>)))
  "Returns md5sum for a message object of type '<object_partyGoal>"
  "20b0ba85943321453eb7e443252d4a76")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'object_partyGoal)))
  "Returns md5sum for a message object of type 'object_partyGoal"
  "20b0ba85943321453eb7e443252d4a76")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<object_partyGoal>)))
  "Returns full string definition for message of type '<object_partyGoal>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'object_partyGoal)))
  "Returns full string definition for message of type 'object_partyGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# define the goal~%string input~%string object1~%string object2~%string object3~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <object_partyGoal>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <object_partyGoal>))
  "Converts a ROS message object to a list"
  (cl:list 'object_partyGoal
