"""autogenerated by genpy from upperbodycore_msgs/slamactionAction.msg. Do not edit."""
import sys
...
class slamactionAction(genpy.Message):
  _md5sum = "1e7fbab38f40096dc0eb5db5d16c6d7b"
  _type = "upperbodycore_msgs/slamactionAction"
...
"""
  ...
  _slot_types = ['upperbodycore_msgs/slamactionActionGoal','upperbodycore_msgs/slamactionActionResult','upperbodycore_msgs/slamactionActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(slamactionAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = upperbodycore_msgs.msg.slamactionActionGoal()
      if self.action_result is None:
        self.action_result = upperbodycore_msgs.msg.slamactionActionResult()
      if self.action_feedback is None:
        self.action_feedback = upperbodycore_msgs.msg.slamactionActionFeedback()
    else:
      self.action_goal = upperbodycore_msgs.msg.slamactionActionGoal()
      self.action_result = upperbodycore_msgs.msg.slamactionActionResult()
      self.action_feedback = upperbodycore_msgs.msg.slamactionActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d.pack(_x.action_goal.goal.x, _x.action_goal.goal.y, _x.action_goal.goal.yaw))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_d.pack(self.action_feedback.feedback.feedback))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.x, _x.action_goal.goal.y, _x.action_goal.goal.yaw,) = _struct_3d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.feedback,) = _struct_d.unpack(str[start:end])
      return self
