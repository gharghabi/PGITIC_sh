"""autogenerated by genpy from upperbodycore_msgs/logic_gripActionFeedback.msg. Do not edit."""
import sys
...
class logic_gripActionFeedback(genpy.Message):
  _md5sum = "6d3d0bf7fb3dda24779c010a9f3eb7cb"
  _type = "upperbodycore_msgs/logic_gripActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','upperbodycore_msgs/logic_gripFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(logic_gripActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = upperbodycore_msgs.msg.logic_gripFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = upperbodycore_msgs.msg.logic_gripFeedback()
