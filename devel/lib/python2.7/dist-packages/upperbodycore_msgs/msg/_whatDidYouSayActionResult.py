"""autogenerated by genpy from upperbodycore_msgs/whatDidYouSayActionResult.msg. Do not edit."""
import sys
...
class whatDidYouSayActionResult(genpy.Message):
  _md5sum = "5489bcfa93e36e07a0b801f3ac4c7c97"
  _type = "upperbodycore_msgs/whatDidYouSayActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','upperbodycore_msgs/whatDidYouSayResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(whatDidYouSayActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = upperbodycore_msgs.msg.whatDidYouSayResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = upperbodycore_msgs.msg.whatDidYouSayResult()
