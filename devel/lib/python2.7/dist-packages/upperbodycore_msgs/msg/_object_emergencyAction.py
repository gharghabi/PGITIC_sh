"""autogenerated by genpy from upperbodycore_msgs/object_emergencyAction.msg. Do not edit."""
import sys
...
class object_emergencyAction(genpy.Message):
  _md5sum = "f2bd760968a1984681c9fec2bd52ac64"
  _type = "upperbodycore_msgs/object_emergencyAction"
...
"""
  ...
  _slot_types = ['upperbodycore_msgs/object_emergencyActionGoal','upperbodycore_msgs/object_emergencyActionResult','upperbodycore_msgs/object_emergencyActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(object_emergencyAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = upperbodycore_msgs.msg.object_emergencyActionGoal()
      if self.action_result is None:
        self.action_result = upperbodycore_msgs.msg.object_emergencyActionResult()
      if self.action_feedback is None:
        self.action_feedback = upperbodycore_msgs.msg.object_emergencyActionFeedback()
    else:
      self.action_goal = upperbodycore_msgs.msg.object_emergencyActionGoal()
      self.action_result = upperbodycore_msgs.msg.object_emergencyActionResult()
      self.action_feedback = upperbodycore_msgs.msg.object_emergencyActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.object
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3I.pack(_x.action_result.result.x, _x.action_result.result.y, _x.action_result.result.z, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.object = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.object = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (_x.action_result.result.x, _x.action_result.result.y, _x.action_result.result.z, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_3d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
