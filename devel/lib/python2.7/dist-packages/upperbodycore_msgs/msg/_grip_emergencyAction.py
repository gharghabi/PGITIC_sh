"""autogenerated by genpy from upperbodycore_msgs/grip_emergencyAction.msg. Do not edit."""
import sys
...
class grip_emergencyAction(genpy.Message):
  _md5sum = "d3bc4470986062662a470c4ae10aece6"
  _type = "upperbodycore_msgs/grip_emergencyAction"
...
"""
  ...
  _slot_types = ['upperbodycore_msgs/grip_emergencyActionGoal','upperbodycore_msgs/grip_emergencyActionResult','upperbodycore_msgs/grip_emergencyActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(grip_emergencyAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = upperbodycore_msgs.msg.grip_emergencyActionGoal()
      if self.action_result is None:
        self.action_result = upperbodycore_msgs.msg.grip_emergencyActionResult()
      if self.action_feedback is None:
        self.action_feedback = upperbodycore_msgs.msg.grip_emergencyActionFeedback()
    else:
      self.action_goal = upperbodycore_msgs.msg.grip_emergencyActionGoal()
      self.action_result = upperbodycore_msgs.msg.grip_emergencyActionResult()
      self.action_feedback = upperbodycore_msgs.msg.grip_emergencyActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.destination
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.destination = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.destination = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
