...
void chatterCallback_right_shoulder_yaw(const upperbodycore_msgs::motor::ConstPtr &msg)
{
    g_Motor_right[0] = msg->position;
    sp_Motor_right[0] = msg->speed;
}

void chatterCallback_right_shoulder_pitch(const upperbodycore_msgs::motor::ConstPtr &msg)
{
    g_Motor_right[2] = msg->position;
    sp_Motor_right[2] = msg->speed;
}

void chatterCallback_right_shoulder_roll(const upperbodycore_msgs::motor::ConstPtr &msg)
{
    g_Motor_right[4] = msg->position;
    sp_Motor_right[4] = msg->speed;
}

void chatterCallback_right_elbow_pitch(const upperbodycore_msgs::motor::ConstPtr &msg)
{
    g_Motor_right[5] = msg->position;
    sp_Motor_right[5] = msg->speed;
}

void chatterCallback_right_elbow_roll(const upperbodycore_msgs::motor::ConstPtr &msg)
{
    g_Motor_right[6] = msg->position;
    sp_Motor_right[6] = msg->speed;
}

void chatterCallback_right_wrist_pitch(const upperbodycore_msgs::motor::ConstPtr &msg)
{
    g_Motor_right[7] = msg->position;
    sp_Motor_right[7] = msg->speed;
}

void chatterCallback_right_wrist_roll(const upperbodycore_msgs::motor::ConstPtr &msg)
{
    g_Motor_right[8] = msg->position;
    sp_Motor_right[8] = msg->speed;
}

void chatterCallback_right_gripper(const upperbodycore_msgs::motor::ConstPtr &msg)
{
...
void chatterCallback_left_shoulder_yaw(const upperbodycore_msgs::motor::ConstPtr &msg)
{
    g_Motor_left[0] = msg->position;
    sp_Motor_left[0] = msg->speed;
}

void chatterCallback_left_shoulder_pitch(const upperbodycore_msgs::motor::ConstPtr &msg)
{
    g_Motor_left[2] = msg->position;
    sp_Motor_left[2] = msg->speed;
}

void chatterCallback_left_shoulder_roll(const upperbodycore_msgs::motor::ConstPtr &msg)
{
    g_Motor_left[4] = msg->position;
    sp_Motor_left[4] = msg->speed;
}

void chatterCallback_left_elbow_pitch(const upperbodycore_msgs::motor::ConstPtr &msg)
{
    g_Motor_left[5] = msg->position;
    sp_Motor_left[5] = msg->speed;
}

void chatterCallback_left_elbow_roll(const upperbodycore_msgs::motor::ConstPtr &msg)
{
    g_Motor_left[6] = msg->position;
    sp_Motor_left[6] = msg->speed;
}

void chatterCallback_left_wrist_pitch(const upperbodycore_msgs::motor::ConstPtr &msg)
{
    g_Motor_left[7] = msg->position;
    sp_Motor_left[7] = msg->speed;
}

void chatterCallback_left_wrist_roll(const upperbodycore_msgs::motor::ConstPtr &msg)
{
    g_Motor_left[8] = msg->position;
    sp_Motor_left[8] = msg->speed;
}

void chatterCallback_left_gripper(const upperbodycore_msgs::motor::ConstPtr &msg)
{
...
void chatterCallback_head_yaw(const upperbodycore_msgs::motor::ConstPtr &msg)
{
    g_Motor_head[0] = msg->position;
    sp_Motor_head[0] = msg->speed;
}

void chatterCallback_head_pitch(const upperbodycore_msgs::motor::ConstPtr &msg)
{
