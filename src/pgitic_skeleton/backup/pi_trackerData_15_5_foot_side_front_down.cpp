...
void chatterCallbackSkeleton(const skeleton_markers::Skeleton msg)
{
    ...
    //***********************left foot**************************//
        ...
        cout<<msg.confidence[11]<<"left foot confidence"<<endl;
        cout<<msg.position[11].x<<" x leftt foot "<<msg.position[14].x<<" x right foot "<<msg.position[9].z<<" x hip chap "<<endl;
        ...
        //     }
        // }
        // else if(msg.position[11].z>(msg.position[2].z+2*abs(msg.position[9].x-msg.position[2].x)))//paye chape man mishe paye raste in baraye dastesh in juri nabud
        // {
        //     if((msg.confidence[11]>0.5)&&(msg.confidence[9]>0.5)&&(msg.confidence[2]>0.5))
        //     {
        //         cout<<"left foot back "<<endl;
...
//***********************right foot**************************//
        ...
        // else if(msg.position[14].z>(msg.position[2].z+2*abs(msg.position[12].x-msg.position[2].x)))//paye chape man mishe paye raste in baraye dastesh in juri nabud
        // {
        //     if((msg.confidence[14]>0.5)&&(msg.confidence[12]>0.5)&&(msg.confidence[2]>0.5))
        //     {
        //         cout<<"right foot back "<<endl;
