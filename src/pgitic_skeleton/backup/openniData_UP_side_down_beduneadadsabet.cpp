...
// 4,1,2,10,7,3,12,5,13,0,8,6,9,11,14               
                ...
                if (((last - first) > 5) && (first != 0)) //?user id ham bayad check shavad
                {
                    ...
                    if (abs(transform[12].getOrigin().x()-transform[1].getOrigin().x())>2.2*(abs(transform[1].getOrigin().y()-transform[2].getOrigin().y())))
                    {
                             cout<<" side "<<endl;      
                             cout<<"tafazole y neck va torso "<<abs(transform[1].getOrigin().y()-transform[2].getOrigin().y())<<endl;
                             cout<<"tafazole x dast va neck "<<abs(transform[12].getOrigin().x()-transform[1].getOrigin().x())<<endl;
                    }
                    else if ((abs(transform[7].getOrigin().x()-joints[7].x)>0.6))//shoulder az avvalie bozargtar az 60
                    {
                        cout<<" front "<<endl;
                    }
                    else if ((abs(transform[12].getOrigin().y()-transform[1].getOrigin().y())>(0.8)*(abs(transform[1].getOrigin().y()-transform[2].getOrigin().y()))) &&     
                        (transform[12].getOrigin().y()-transform[1].getOrigin().y()<0))
                    {
                        cout<<" up"<<endl;
                    } 
                     else if ((abs(transform[12].getOrigin().y()-transform[1].getOrigin().y())>(1.2)*(abs(transform[1].getOrigin().y()-transform[2].getOrigin().y()))) &&     
                        (transform[12].getOrigin().y()-transform[1].getOrigin().y()>0))
                    {
                        cout<<" down"<<endl;
                    } 
