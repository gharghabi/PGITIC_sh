...
int main(int argc, char **argv)
{
    ...
    ofstream average(argv[2]);
     if (motors_info.is_open())
                {
                    motors_info <<" head    "<<" neck   "<<" torso   "<<" right elbow   "<<" right_shoulder_"<<" right hand    "<<"\n";            
                }
     if (average.is_open())
                {
                    average <<" head    "<<" neck   "<<" torso   "<<" right elbow   "<<" right_shoulder_"<<" right hand    "<<"\n";            
                }
            ...
            try
            {
               ...
               listener.lookupTransform("/head_" + open_ni_code_str, "/openni_depth_frame", ros::Time(0), transform[4]);
                ...
                for(int i=averagesize-2;i>=0;i--)
                 ...
                 if (motors_info.is_open())
                    {
                        motors_info <<transform[4].getOrigin().y()<<","<<transform[1].getOrigin().y()<<","<<transform[2].getOrigin().y()<<","<<transform[3].getOrigin().x()<<","<<transform[7].getOrigin().x()<<","<<transform[12].getOrigin().x()<<"\n";            
                    }
                ...
                if (((last - first) > 5) && (first != 0)) //?user id ham bayad check shavad
                {
                    ...
                    if (abs(transform[12].getOrigin().x()-joints[12].x)>0.2)
                    {
                         cout<<" side "<<endl;       
                    }
                     if ((abs(transform[7].getOrigin().x()-joints[7].x)>0.6))//shoulder az avvalie bozargtar az 60
                    {
                        cout<<" front "<<endl;
                    }
                    // else
                    ...
                    //     cout<<"down "<<endl;
                    // }
                    cout<<transform[7].getOrigin().y()<<" y alan "<<endl;
                    cout<<joints[7].y<< " y avval "<<endl;
                    int trust = 0;
