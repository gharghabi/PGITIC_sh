"""autogenerated by genpy from upperbodycore_msgs/object_partyAction.msg. Do not edit."""
import sys
...
class object_partyAction(genpy.Message):
  _md5sum = "cc72eadee417633564ff88ff9c8b6b1f"
  _type = "upperbodycore_msgs/object_partyAction"
...
"""
  ...
  _slot_types = ['upperbodycore_msgs/object_partyActionGoal','upperbodycore_msgs/object_partyActionResult','upperbodycore_msgs/object_partyActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(object_partyAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = upperbodycore_msgs.msg.object_partyActionGoal()
      if self.action_result is None:
        self.action_result = upperbodycore_msgs.msg.object_partyActionResult()
      if self.action_feedback is None:
        self.action_feedback = upperbodycore_msgs.msg.object_partyActionFeedback()
    else:
      self.action_goal = upperbodycore_msgs.msg.object_partyActionGoal()
      self.action_result = upperbodycore_msgs.msg.object_partyActionResult()
      self.action_feedback = upperbodycore_msgs.msg.object_partyActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.object1
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.object2
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.object3
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_result.result.object_find
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.input = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.object1 = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.object1 = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.object2 = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.object2 = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.object3 = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.object3 = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_result.result.object_find = str[start:end].decode('utf-8')
      else:
        self.action_result.result.object_find = str[start:end]
      _x = self
      start = end
      end += 36
