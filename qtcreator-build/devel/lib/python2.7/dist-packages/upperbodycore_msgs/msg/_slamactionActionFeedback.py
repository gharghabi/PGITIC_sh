"""autogenerated by genpy from upperbodycore_msgs/slamactionActionFeedback.msg. Do not edit."""
import sys
...
class slamactionActionFeedback(genpy.Message):
  _md5sum = "d864e15b323daea030df928d72ca3f47"
  _type = "upperbodycore_msgs/slamactionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','upperbodycore_msgs/slamactionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(slamactionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = upperbodycore_msgs.msg.slamactionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = upperbodycore_msgs.msg.slamactionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_d.pack(self.feedback.feedback))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.feedback,) = _struct_d.unpack(str[start:end])
      return self
