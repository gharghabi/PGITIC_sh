"""autogenerated by genpy from upperbodycore_msgs/logic_gripActionResult.msg. Do not edit."""
import sys
...
class logic_gripActionResult(genpy.Message):
  _md5sum = "5489bcfa93e36e07a0b801f3ac4c7c97"
  _type = "upperbodycore_msgs/logic_gripActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','upperbodycore_msgs/logic_gripResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(logic_gripActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = upperbodycore_msgs.msg.logic_gripResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = upperbodycore_msgs.msg.logic_gripResult()
