"""autogenerated by genpy from upperbodycore_msgs/sepantaAction.msg. Do not edit."""
import sys
...
class sepantaAction(genpy.Message):
  _md5sum = "79edad236168de54554144835c4dda5f"
  _type = "upperbodycore_msgs/sepantaAction"
...
"""
  ...
  _slot_types = ['upperbodycore_msgs/sepantaActionGoal','upperbodycore_msgs/sepantaActionResult','upperbodycore_msgs/sepantaActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(sepantaAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = upperbodycore_msgs.msg.sepantaActionGoal()
      if self.action_result is None:
        self.action_result = upperbodycore_msgs.msg.sepantaActionResult()
      if self.action_feedback is None:
        self.action_feedback = upperbodycore_msgs.msg.sepantaActionFeedback()
    else:
      self.action_goal = upperbodycore_msgs.msg.sepantaActionGoal()
      self.action_result = upperbodycore_msgs.msg.sepantaActionResult()
      self.action_feedback = upperbodycore_msgs.msg.sepantaActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_goal.goal.value, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.value, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
