"""autogenerated by genpy from upperbodycore_msgs/gripActionResult.msg. Do not edit."""
import sys
...
class gripActionResult(genpy.Message):
  _md5sum = "5489bcfa93e36e07a0b801f3ac4c7c97"
  _type = "upperbodycore_msgs/gripActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','upperbodycore_msgs/gripResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(gripActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = upperbodycore_msgs.msg.gripResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = upperbodycore_msgs.msg.gripResult()
