"""autogenerated by genpy from upperbodycore_msgs/avoidThatAction.msg. Do not edit."""
import sys
...
class avoidThatAction(genpy.Message):
  _md5sum = "8fb251f3339c25ce6273a5c1c3affe02"
  _type = "upperbodycore_msgs/avoidThatAction"
...
"""
  ...
  _slot_types = ['upperbodycore_msgs/avoidThatActionGoal','upperbodycore_msgs/avoidThatActionResult','upperbodycore_msgs/avoidThatActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(avoidThatAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = upperbodycore_msgs.msg.avoidThatActionGoal()
      if self.action_result is None:
        self.action_result = upperbodycore_msgs.msg.avoidThatActionResult()
      if self.action_feedback is None:
        self.action_feedback = upperbodycore_msgs.msg.avoidThatActionFeedback()
    else:
      self.action_goal = upperbodycore_msgs.msg.avoidThatActionGoal()
      self.action_result = upperbodycore_msgs.msg.avoidThatActionResult()
      self.action_feedback = upperbodycore_msgs.msg.avoidThatActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_goal.goal.input, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.input, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
