...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'pgitic_senario' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shaghayegh/catkin_ws/install/${idir}'.  Ask the maintainer 'PGITIC_vision_skeleton <PGITIC_vision@todo.todo>' to fix it.")
    endif()
