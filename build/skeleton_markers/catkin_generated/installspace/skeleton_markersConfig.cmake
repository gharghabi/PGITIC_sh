...
if("FALSE" STREQUAL "TRUE")
  set(skeleton_markers_SOURCE_PREFIX /home/shaghayegh/catkin_ws/src/skeleton_markers)
  set(skeleton_markers_DEVEL_PREFIX /home/shaghayegh/catkin_ws/devel)
  ...
  set(skeleton_markers_INSTALL_PREFIX /home/shaghayegh/catkin_ws/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'skeleton_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shaghayegh/catkin_ws/install/${idir}'.  Ask the maintainer 'Patrick Goebel <patrick@pirobot.org>' to fix it.")
    endif()
...
set(depends "rospy;roscpp;message_runtime;openni_camera;openni_tracker;tf;visualization_msgs;std_msgs;geometry_msgs;upperbodycore_msgs")
